...
4. **Build and maintain a community-driven aspect library or extension.**
    ...
    For details, see [how to contribute code](xref:contribute-code).
...
5. **Contribute to the documentation.**
    ...
    For details, see [how to contribute documentation](xref:contribute-docs).

6. **Contribute to the core projects.**

    You're welcome to fix bugs (either new ones or already-reported ones) directly in the core projects. See [how to contribute code](xref:contribute-code) for instructions. For new features, please first create a proposal and discuss it with the core maintainers.
