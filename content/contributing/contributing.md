...
keywords: "contributing, Metalama, open source, community, aspects, marketplace, documentation, core projects"
created-date: 2025-02-13
modified-date: 2026-08-04
---

# Contributing to Metalama
...
Before you dive in, read the sections below to get up to speed with how we work and what we expect from contributors. Following the guidelines will save both your time and ours.

Let's make Metalama better together.
...
5. **Contribute to the documentation.**
    ...
    For details, see <xref:contribute-docs>.

6. **Contribute to the core projects.**

    You're welcome to fix bugs (either new ones or already-reported ones) directly in the core projects. See <xref:contribute-code> for instructions. For new features, first create a proposal and discuss it with the core maintainers.

## In this section

| Article | Description |
|---------|-------------|
| <xref:file-an-issue> | Explains where to report a bug and what to include in the report. |
| <xref:contribute-code> | Walks through the quality process for a code contribution, from choosing a repository to submitting the PR. |
| <xref:contribute-docs> | Explains how to author an article or a code sample and rebuild the documentation. |
| <xref:build-from-source> | Describes the requirements and the scripts that build Metalama, including multi-repo and Docker builds. |
| <xref:coding-standard> | Lists the coding conventions and the tools that enforce them. |
| <xref:branching> | Describes the Git flow, the branch naming conventions, and the release process. |
| <xref:cla> | Gives the full text of the Contribution License Agreement and explains when you sign it. |

> [!div class="see-also"]
> <xref:file-an-issue>
> <xref:contribute-code>
> <xref:contribute-docs>
