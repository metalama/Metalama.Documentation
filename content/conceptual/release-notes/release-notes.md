...
This article provides a high-level changelog for major Metalama releases. For detailed changelogs of individual builds, including bug fixes and minor enhancements, see the [GitHub Releases](https://github.com/metalama/Metalama/releases) page.
