...
This chapter provides a high-level changelog for major Metalama releases. For detailed changelogs of individual builds, including bug fixes and minor enhancements, see the [GitHub Releases](https://github.com/metalama/Metalama/releases) page.
...
| 2025.1  | Stable               | The first open-source Metalama release. There are some breaking changes in packages and namespaces of the new components that remain proprietary. | <xref:release-notes-2025.1> |
