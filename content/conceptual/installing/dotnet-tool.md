...
keywords: "command line tool, dotnet tool, configuration, license, processes, temporary files"
...
To install the Metalama command line tool, run the following command:
