...
This section provides guidance on configuring Metalama.

| Article | Description |
|---------|-------------|
| <xref:telemetry> | Explains the data collected through telemetry and how to disable it. |
| <xref:msbuild-properties> | Lists MSBuild properties and environment variables recognized by Metalama. |
...
| <xref:diagnosing-memory-leaks> | Explains how to find out which of your compile-time objects keeps a project snapshot in memory. |
