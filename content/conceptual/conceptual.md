...
| <xref:using-metalama> | This chapter details how to use Metalama with prebuilt aspects. It doesn't, however, cover how to create your own aspects. |
...
| <xref:introspection> | This chapter explains how to query and analyze code using the Workspaces API or LINQPad. |
