...
| <xref:Metalama.Framework.Code.Collections> | Contains specialized collections for the code model, including <xref:Metalama.Framework.Code.Collections.IDeclarationCollection`1> and related types.                                                |
| <xref:Metalama.Framework.Code.Types>        | Defines special type representations like <xref:Metalama.Framework.Code.Types.ITypeParameter>, <xref:Metalama.Framework.Code.Types.IArrayType>, and <xref:Metalama.Framework.Code.Types.IPointerType>.                                                 |
