...
| <xref:Metalama.Extensions.Architecture> | A high-level compile-time API, built on <xref:Metalama.Extensions.Validation>, that allows your enforce your architecture. |
