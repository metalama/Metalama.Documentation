...
These namespaces are used when writing your own aspects or fabrics.
...
| <xref:Metalama.Framework.Fabrics>    | Provides the ability to add aspects or validators to entire projects and namespaces, and to configure aspects.                                             |
